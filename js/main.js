      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          if (xhttpresponse.indexOf(subsha1pass) !== -1) {
            ...
            document.getElementById("iscompromised").innerHTML = '<span style="color: #ff0000;">This password was found <b>'+ pwnedcount + '</b> '+ timespell + '<&nbsp>in breached records. <br> You should change your password.</h4></span>';
          }else {
